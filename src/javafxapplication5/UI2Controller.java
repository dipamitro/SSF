...
public class UI2Controller implements Initializable {
    ...
    private void loadLineChartButtonOnClick(ActionEvent event) {
        ...
        boolean add = series1.getData().add(new XYChart.Data<>("Feb",500));
        ...
        series3.getData().add(new XYChart.Data<>("Jan",500));
        series3.getData().add(new XYChart.Data<>("Feb",900));
        series3.getData().add(new XYChart.Data<>("Mar",450));
        series3.getData().add(new XYChart.Data<>("Apr",650));
