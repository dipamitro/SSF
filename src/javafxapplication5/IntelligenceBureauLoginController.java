 ...
 * @author DIPA
 */
public class IntelligenceBureauLoginController implements Initializable {
    ...
    private void loginButtonOnClick(ActionEvent event) throws IOException {
        ...
        if(event.getSource()==button){
           ...
           if(username.equalsIgnoreCase("12345")&& password.equalsIgnoreCase("dipa")){
              
               Stage primaryStage = new Stage();
                Parent root = FXMLLoader.load(getClass().getResource("IntelligenceBureauHomePage.fxml"));
